...
class TaskResourceTest {
    ...
    @Test
    void shouldReturnTasksWhenListAllWithContent() {
    ...
    @Test
    void shouldReturnNoContentWhenListAllIsEmpty() {
    ...
    @Test
    void shouldReturnCompletedTasksWhenListCompletedWithContent() {
        var task = new ListTasksUseCase.Response(1L, "Test", "Desc", COMPLETED);
        var page = new Page<>(List.of(task), 0, 10, 1);
        when(listTasksUseCase.execute(COMPLETED, 0, 10)).thenReturn(page);
    ...
    @Test
    void shouldReturnNoContentWhenListCompletedIsEmpty() {
        var page = new Page<ListTasksUseCase.Response>(List.of(), 0, 10, 0);
        when(listTasksUseCase.execute(COMPLETED, 0, 10)).thenReturn(page);
    ...
    @Test
    void shouldUpdateTaskWhenRequestIsValid() {
